...
double Get_CFL(Block2d& block, Fluid2d* fluids, double tstop, Interface2d* xinterfaces, Interface2d* yinterfaces);
double Get_CFL1(Block2d& block, Fluid2d* fluids, double tstop);
double Get_CFL2(Block2d& block, Fluid2d* fluids, double tstop);
...
void Reconstruction_within_cell_du(Interface2d* xinterfaces, Interface2d* yinterfaces, Fluid2d* fluids, Block2d block);
...
void WENO5_left(double& var, double& der1, double& der2, int& zeta, double wn2, double wn1, double w, double wp1, double wp2, double h);
void WENO5_right(double& var, double& der1, double& der2, int& zeta, double wn2, double wn1, double w, double wp1, double wp2, double h);


void WENO7_normal(Interface2d& left, Interface2d& right, Interface2d& down, Interface2d& up, Fluid2d* fluids, Block2d block);
void WENO7(Point2d& left, Point2d& right, double* wm3, double* wm2, double* wm1, double* w, double* wp1, double* wp2, double* wp3, double h);
void WENO7_left(double& var, double& der1, double& der2, double wm3, double wm2, double wm1, double w, double wp1, double wp2, double wp3, double h);
void WENO7_right(double& var, double& der1, double& der2, double wm3, double wm2, double wm1, double w, double wp1, double wp2, double wp3, double h);

void WENO_du(Point2d& left, Point2d& right, double* wn2, double* wn1, double* w, double* wp1, double* wp2, double h);
void WENO5_normal_du(Interface2d& left, Interface2d& right, Interface2d& down, Interface2d& up, Fluid2d* fluids, Block2d block);
void WENO5_left_du(double& var, double& der1, double& der2,double wn2, double wn1, double w, double wp1, double wp2, double h);
void WENO5_right_du(double& var, double& der1, double& der2, double wn2, double wn1, double w, double wp1, double wp2, double h);
...
void TENO6_normal(Interface2d& left, Interface2d& right, Interface2d& down, Interface2d& up, Fluid2d* fluids, Block2d block);
void TENO6(Point2d& left, Point2d& right, double* wm3, double* wm2, double* wm1, double* w, double* wp1, double* wp2, double* wp3, double h);
void TENO6_left(double& var, double& der1, double& der2, double wm3, double wm2, double wm1, double w, double wp1, double wp2, double wp3, double h);
void TENO6_right(double& var, double& der1, double& der2, double wm3, double wm2, double wm1, double w, double wp1, double wp2, double wp3, double h);
...
void WENO5_left(double& var, double& der1, double& der2, double wn2, double wn1, double w, double wp1, double wp2, double h);
void WENO5_right(double& var, double& der1, double& der2, double wn2, double wn1, double w, double wp1, double wp2, double h);
void WENO5_leftc(double& var, double& der1, double& der2, int& zeta, double wn2, double wn1, double w, double wp1, double wp2, double h);
void WENO5_rightc(double& var, double& der1, double& der2, int& zeta, double wn2, double wn1, double w, double wp1, double wp2, double h);
...
void GKS2D(Flux2d &flux, Recon2d& interface, double dt,double n1x,double n1y,double n2x,double n2y,int cell,int gs,int xy, Fluid2d* fluids);
//void CGKS2D(Flux2d& flux, Recon2d& interface, double dt, double n1x, double n1y, double n2x, double n2y, int cell, int gs, int xy, Fluid2d* fluids);
...
void comput_du_LW_Old(Interface2d* xinterfaces, Interface2d* yinterfaces, Block2d block, Fluid2d* fluids);
void scheme_du_dx_New(Interface2d* xinterfaces, Interface2d* yinterfaces, Flux2d_gauss** xfluxes, Flux2d_gauss** yfluxes, Block2d block, int stage, Fluid2d* fluids);
...
void Update_RK22(Fluid2d* fluids, Flux2d_gauss** xfluxes, Flux2d_gauss** yfluxes, Block2d block, int stage, Interface2d* xinterfaces, Interface2d* yinterfaces);
void Update_RK33(Fluid2d* fluids, Flux2d_gauss** xfluxes, Flux2d_gauss** yfluxes, Block2d block, int stage, Interface2d* xinterfaces, Interface2d* yinterfaces);
void Update_TDRK23(Fluid2d* fluids, Flux2d_gauss** xfluxes, Flux2d_gauss** yfluxes, Block2d block, int stage, Interface2d* xinterfaces, Interface2d* yinterfaces);
void store_du_duu(Fluid2d* fluids, Block2d block);

void Update_TDMS23(Fluid2d* fluids, Flux2d_gauss** xfluxes, Flux2d_gauss** yfluxes, Block2d block, int stage, Interface2d* xinterfaces, Interface2d* yinterfaces);
void Update_TDMSRK223(Fluid2d* fluids, Flux2d_gauss** xfluxes, Flux2d_gauss** yfluxes, Block2d block, int stage, Interface2d* xinterfaces, Interface2d* yinterfaces);

void Update_FDM(Fluid2d* fluids, Flux2d_gauss** xfluxes, Flux2d_gauss** yfluxes, Block2d block, int stage, Interface2d* xinterfaces, Interface2d* yinterfaces);
void Update_DeC3_1(Fluid2d* fluids, Flux2d_gauss** xfluxes, Flux2d_gauss** yfluxes, Block2d block, Interface2d* xinterfaces, Interface2d* yinterfaces);
void Update_DeC3(Fluid2d* fluids, Flux2d_gauss** xfluxes, Flux2d_gauss** yfluxes, Block2d block, Interface2d* xinterfaces, Interface2d* yinterfaces);
void Update_DeC5_1(Fluid2d* fluids, Flux2d_gauss** xfluxes, Flux2d_gauss** yfluxes, Block2d block, Interface2d* xinterfaces, Interface2d* yinterfaces);
void Update_DeC5(Fluid2d* fluids, Flux2d_gauss** xfluxes, Flux2d_gauss** yfluxes, Block2d block, Interface2d* xinterfaces, Interface2d* yinterfaces);
