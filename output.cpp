...
void output2d_center(Fluid2d* fluids, Block2d block)
{
	...
	out << "variables = x,y,density,u,v,pressure,temperature,entropy,sersor" << endl;
...
void output_record(Block2d block)
{
	...
	else if (cellreconstruction_2D_normal == WENO5_AO_normal)
	{
	...
	if (cellreconstruction_2D_tangent == WENO5_AO_tangent)
	{
		out << "WENO5_AO_tangent " << endl;
	}
